...
public class RaDecECFService {
     ...
     * matching EME2000&rarr;ITRF transforms (which depend only on the date), and
     ...
     * EME2000&rarr;ITRF transform at a given instant is identical for every
     ...
     * timestamp, using the precomputed (satellite-independent) ECI&rarr;ECF
    ...
    private RaDecECF getRaDecRange(AbsoluteDate absoluteDate, Transform eciToEcf,
        ...
        // Orekit 13: measurement builders return EstimatedMeasurementBase; the
        // observed [RA, Dec] value is read off it directly.
        final EstimatedMeasurementBase<AngularRaDec> angularRaDec =
                angularRaDecBuilder.build(absoluteDate, new SpacecraftState[]{spacecraftState});
